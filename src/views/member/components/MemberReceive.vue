  ...
  <div class="app-container">
    <el-row>
      ...
      <el-col :span="24" align="center" style="margin-top:8px;margin-bottom:16px;">
        <span style="font-size: 18px;">{{ orgData.TempHeader }}</span>
      </el-col>
      ...
      <el-col :span="24" align="center" style="margin-bottom:12px;">
        <vue-qrcode :value="ktbCode" :options="{ width: 200 }" />
      </el-col>
      <el-col :span="24" align="center" style="margin-bottom:12px;line-height: 2;">
        <span style="font-size: 16px;">{{ orgData.TempFooter }}</span>
      </el-col>
      <el-col :span="24" align="center" style="margin-bottom:12px;">
      ...
      <el-col :span="24" align="center" style="margin-bottom:12px;">
        <el-button type="primary" class="button" @click="paymentVerifyClick">ส่งหลักฐานการโอน</el-button>
      </el-col>
    </el-row>
  </div>
</template>
...
import { getOrgType, getURL, getUserDetailData } from '@/utils/auth'
...
export default {
  ...
  methods: {
    paymentVerifyClick() {
      this.$router.push({ path: '/member/payment_verify/' + this.bookList.B01 })
    },
    getDataUri(url) {
